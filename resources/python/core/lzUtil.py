...
dr.maximize_window()
dr.get('http://www.longzhu.com')
time.sleep(5)
# 登录
dr.find_element_by_css_selector("body > div.zoomtip-dialog > div.zoomtip-dialog-title.zoomtip-dialog-title-draggable > span.zoomtip-dialog-title-close").click()
time.sleep(5)
dr.find_element_by_css_selector("#topbar-login-button > span").click()
time.sleep(5)
dr.find_element_by_css_selector(".field-longzhu-zh > input:nth-child(1)").send_keys("15850358189")
time.sleep(5)
dr.find_element_by_css_selector(".field-longzhu-password > input:nth-child(1)").send_keys("yang729")
time.sleep(5)
dr.find_element_by_css_selector("#longzhu-login > button").click()
# 爬取房间链接
